#!/usr/bin/env bash
# Screen selected NER W2A4/W4A2 dual-outlier8 configurations.
...
LOG_DIR="$PROJECT_ROOT/base_exp/exp_edge/local_logs/ner_w2a4_w4a2_out8_$RUN_ID"
...
run_one() {
  ...
  local label="$5"
  local run_name="ptq_oa_${label}_fixedseed20260806_ms256_ner_e3"
