#!/usr/bin/env bash
# Scan six ultra-low NER W4A4 dual-outlier8 budgets with a fixed seed.
...
LOG_DIR="$PROJECT_ROOT/base_exp/exp_edge/local_logs/ner_w4a4_ultralow_out8_$RUN_ID"
...
run_one() {
  ...
  local label="$4"
  local run_name="ptq_oa_w4a4_dualout8_ultralow_${label}_fixedseed20260806_cal16_ms256_ner_e3"
